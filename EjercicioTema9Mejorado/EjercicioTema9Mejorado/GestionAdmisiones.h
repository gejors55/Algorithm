...
class tPaciente{
public:
	tPaciente(const Paciente paciente, const Gravedad grav, Lista<CodigoPaciente>::Iterator it);
	const Gravedad& gravedad() const;
	const Lista<CodigoPaciente>::Iterator & iteradores() const;
...
private:
  ...
  // eficientemente este TAD
	DiccionarioHash<CodigoPaciente, tPaciente> dic;
	Lista<CodigoPaciente> listaGraves;
	Lista<CodigoPaciente> listaLeves;
	Lista<CodigoPaciente> listaNormal;
